...
// Update your existing JS with these mobile-specific enhancements
...
if (isTouchDevice) {
    ...
    const hoverElements = document.querySelectorAll('.skill-item, .timeline-content, .nav-link');
    hoverElements.forEach(el => {
        el.classList.add('touch-hover');
    });
}

// Prevent default touchmove to stop rubber-band effect on iOS
...
// Better touch handling for navigation
navLinks.forEach(link => {
